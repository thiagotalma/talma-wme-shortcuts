var versao = '0.1',
    ...
    talmaLog = function (str) {
        if (typeof TALMA_DEBUG != "undefined" && TALMA_DEBUG !== false && typeof console.log == "function") {
    ...
    talmaAcertarNomeRuaInit = function () {
        ...
        if ($body.data('acertaRuaBookmarkletSet')) {
            if (typeof TALMA_ALERT == "undefined" || TALMA_ALERT !== false) {
                alert("Talma WME Shortcut\n\nAjustar Nome da Rua: Recarregado!\n\nVersão: " + versao);
            }
            return false;
        }
        ...
        if (typeof TALMA_ALERT == "undefined" || TALMA_ALERT !== false) {
            alert("Talma WME Shortcut\n\nAjustar Nome da Rua: Pronto!\n\nVersão: " + versao);
        }
    },

    acertarNomeRua = function () {
    };
